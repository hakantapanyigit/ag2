...
See the official AutoGen Studio documentation [here](/website/docs/autogen-studio/getting-started) for more details.
...
To get started, you need access to a language model. You can get this set up by following the steps in the AutoGen documentation [here](/website/docs/FAQ#set-your-api-endpoints). Configure your environment with either `OPENAI_API_KEY` or `AZURE_OPENAI_API_KEY`.
