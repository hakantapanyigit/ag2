...
- Integrating multiple [models](/website/blog/2023-11-09-EcoAssistant), [APIs](/website/docs/topics/openai-assistant/gpt_assistant_agent), [modalities](/website/blog/2023-11-06-LMM-Agent) and [memories](/website/blog/2023-10-26-TeachableAgent).
...
- Even if the performance of a single agent is good enough, you may also want to make this single agent teach some other relatively cheaper agent so that they can become
  better with low cost. [EcoAssistant](/website/blog/2023-11-09-EcoAssistant) is a good example of combining GPT-4 and GPT-3.5 agents to reduce the cost while improving the performance even compared to using a single GPT-4 agent.
...
- [AutoDefense](/website/blog/2024-03-11-AutoDefense) demonstrates that using multi-agents reduces the risk of suffering from jailbreak attacks.
