...
- [Swarm Orchestration Documentation](/website/docs/topics/swarm)
- [Swarm Orchestration Notebook](/notebook/agentchat_swarm)
- [(Legacy) Implement Swarm-style Orchestration with GroupChat
  ](/notebook/agentchat_swarm_w_groupchat_legacy)
