...
AutoGen's SQLite and File Logger - [Tutorial Notebook](/notebook/agentchat_logging)

### Full-Service Partner Integrations

- AutoGen partners with [AgentOps](https://agentops.ai) to provide multi-agent tracking, metrics, and monitoring - [Tutorial Notebook](/notebook/agentchat_agentops)
