...
<div style={{ display: "inline-block", marginRight: "0px", height: "20px" }}>
  <a
    href="https://colab.research.google.com/github/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/local-lm-studio.mdx"
    target="_blank"
...
<div style={{ display: "inline-block", height: "20px" }}>
  <a
    href="https://github.com/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/local-lm-studio.mdx"
    target="_blank"
    style={{ height: "20px", display: "inline-flex", alignItems: "center" }}
  >
    <img
